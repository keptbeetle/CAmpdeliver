...
import { ArrowLeft, ChevronRight, Clock, ShoppingBag } from "lucide-react";
    ...
    <div className="flex flex-col gap-6 px-4 py-6 pb-28">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-400">Track current and past deliveries</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3">
        {isLoading ? (
          ...
          orders.map((order: { id: string; canteenName: string; buyerId: string; deliveryLocationName: string; foodPrice: number; deliveryFee: number; status: string; createdAt: Date }) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between border-t border-zinc-800/60 pt-2 text-xs text-zinc-500">
                  ...
                  <span className="flex items-center gap-1 font-bold text-purple-400 group-hover:translate-x-0.5 transition-transform">
